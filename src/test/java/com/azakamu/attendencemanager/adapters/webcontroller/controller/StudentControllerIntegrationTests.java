...
public class StudentControllerIntegrationTests {
  ...
  void vacationEnrollmentTest1() throws Exception {
    mockMvc
        .perform(
            get("/vacationenrollment"))
        .andExpect(view().name("vacationenrollment"))
        .andExpect(status().isOk());
  }
  ...
  void examEnrollmentTest1() throws Exception {
    mockMvc
        .perform(
            get("/examenrollment"))
        .andExpect(view().name("examenrollment"))
        .andExpect(status().isOk());
  }
  ...
  void examCreationTest2() throws Exception {
    mockMvc
        ...
        .andExpect(view().name("examcreation"))
        .andExpect(status().isOk());
  }
    ...
    mockMvc
        .perform(
            post("/enrollVacation")
                ...
                .flashAttr("githubId", student.getGithubId())
                .flashAttr("githubName", student.getGithubName()))
        .andExpect(view().name("redirect:/vacationenrollment"))
        .andExpect(status().is(302));
    ...
    mockMvc
        .perform(
            post("/createExam")
                ...
                .flashAttr("githubId", student.getGithubId())
                .flashAttr("githubName", student.getGithubName()))
        .andExpect(view().name("redirect:/examcreation"))
        .andExpect(status().is(302));
    ...
    mockMvc
        .perform(
            post("/createExam")
                ...
                .flashAttr("githubId", student.getGithubId())
                .flashAttr("githubName", student.getGithubName()))
        .andExpect(view().name("redirect:/examenrollment"))
        .andExpect(status().is(302));
    verify(examService, times(1))
